    ...
    render(){
      ...
      return (
          <View style = {styles.container}>
              ...
              <TouchableOpacity style={{alignSelf:'center',backgroundColor:"#FFC0CB",padding:"5%",paddingLeft:"17%",paddingRight:"17%",borderRadius:50,borderColor:"#c66172",borderWidth:5}} onPress = {this.login}><Text style={{fontWeight:'bold',color:"maroon",fontSize:20}}>LOGIN</Text></TouchableOpacity>
              <TouchableOpacity style={{marginTop:10,alignSelf:'center',padding:5,paddingLeft:100,paddingRight:100}} onPress = {()=>{this.props.navigation.navigate("signUp")}}><Text style={{fontWeight:'bold',color:"maroon",fontSize:20}}>SIGN UP</Text></TouchableOpacity>
